      ...
      <header className="w-full px-8 h-24 bg-[url('/images/bg-header-mobile.svg')] sm:bg-[url('/images/bg-header-desktop.svg')] bg-[#5ba4a4]" >
        <div className="relative h-full mx-auto px-8 max-w-5xl ">
          {arrayFilters.length > 0 &&
            <div className="absolute inset-x-0 -bottom-8 rounded-md bg-white mx-auto max-w-5xl flex items-center bg-white shadow-lg px-8 py-6">
              ...
              <button className="link ml-auto font-semibold hover:underline hover:underline-offset-2 hover:text-[#5ba4a4]" onClick={clearFilter}>Clear</button>
            </div>
          }
        </div>
      </header>
